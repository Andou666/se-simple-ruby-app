...
# 初期設定
KEYID = ENV['HP_ACCESS_KEY']
COUNT = 100
PREF = "Z011" #東京
FORMAT = "json"
PARAMS = {"key": KEY, "count":COUNT, "large_area":PREF, "format":FORMAT}
...
def write_data_to_csv(params)
    ...
    for restaurant in response["results"]["shop"] do
        rest_info = [restaurant["name"], restaurant["address"], restaurant["open"], restaurant["tel"]]
